...
/*
 * 21st.dev carolinaraulino/grid-pulse (id 27200), ported by hand — the project
 * has no components.json, so nothing installs through shadcn.
 *
 * Two changes from the original: the hue band is KeeperHub's green rather than
 * a full spectrum (see HUE_TOP / HUE_SPAN below), and the tint ladder is held
 * in the readable middle because a single-hue field washes out at the pale end.
 */
...
/** Hue at the top of the field and how far it turns by the bottom.
 *  The original ran a full spectrum — yellow through red and blue to green.
 *  Ours stays inside KeeperHub's own band: a cool teal at the top turning to
 *  the mark's spring green at the bottom, so a sweep reads as one colour
 *  moving rather than confetti. */
const HUE_TOP = 192;
const HUE_SPAN = 48;
/**
 ...
 */
const TINTS = [78, 71, 64, 57, 50];
const TINTS_DARK = [66, 60, 54, 48, 42];
