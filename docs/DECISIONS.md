...
- [ ] **Starters vs the selected network** (slice 13.5): on Base Sepolia six of eight launcher starters cannot run. Hide them per network, or keep them and switch the network when picked?
